...
urlpatterns = [
    ...
    path("inbox/<str:ksef_reference_number>/html/", ReceivedInvoiceHtmlView.as_view(), name="ksef-inbox-html"),
    ...
    path("inbox/<str:ksef_reference_number>/mark-paid/", MarkInvoicePaidView.as_view(), name="ksef-inbox-mark-paid"),
